...
- Brand logos used by the **Brand Logo** badge style are sourced from Wikimedia Commons and
  regenerated by `scripts/normalize-logos.py`:
  - Public domain (below the threshold of originality): Dolby Vision, Dolby Atmos,
    Dolby TrueHD, HDR10, DTS-HD Master Audio, AV1, H.264/MPEG-4 AVC, VP9.
...
Dolby, Dolby Vision, Dolby Atmos and TrueHD are trademarks of Dolby Laboratories.
HDR10+ is a trademark of HDR10+ Technologies. DTS is a trademark of DTS, Inc.
JellyTag is not affiliated with, endorsed by, or sponsored by any of these companies.
The logos are used descriptively, to indicate the format of the media being displayed.
The **Brand Logo** badge style is opt-in; the default **Image** style uses generated
text badges that contain no third-party marks.

## License

MIT License

The MIT License covers the plugin source code. Bundled assets keep their own licenses as
described under [Acknowledgments](#acknowledgments).
